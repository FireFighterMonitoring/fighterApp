 ...
 */
public class HeartrateBluetoothDevice {
    private static final String TAG = HeartrateBluetoothDevice.class.getSimpleName();
    ...
    public HeartrateBluetoothDevice(BluetoothDevice device, Context context) {
        this.device = device;
